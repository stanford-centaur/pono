...
class VarTermManager
{
 ...
 public:
  VarTermManager() {}
  void RegisterTermsToWalk(const smt::Term & t)
  {
    // register the init by var and also trans by var, and property
    terms_to_check_.push_back(t);
  }
  ...
  unsigned GetMoreTerms(IC3FormulaModel * pre,
 ...
 protected:
  ...
  void term_const_w1_const(PerVarsetInfo & term_cache_item /*OUT*/,
  ...
  void insert_vars_only(PerVarsetInfo & term_cache_item /*OUT*/,
                        const smt::UnorderedTermSet & varset);

  void insert_split(PerVarsetInfo & term_cache_item /*OUT*/,
                    const smt::UnorderedTermSet & varset,
                    smt::SmtSolver & s);
