...
class PredConstructor
{
 ...
 public:
  ...
  PredConstructor(to_next_t to_next_func,
                  smt::SmtSolver & solver,
                  // const smt::Term & T_btor,
                  // const smt::Term & Init_btor,
                  // const smt::Term & Fprev_btor,
                  IC3FormulaModel * cex,
                  PerCexInfo & per_cex_info  // from pdr class, this will allow
                                             // us to not use static data
                                             // bool init_per_cex_info,
                  // VarTermManager & var_term_extractor
                  // setup_cex_info will be in pdr class
  );

  const smt::TermVec & GetAllPredNext() const
  {
    return per_cex_info_.predicates_nxt;
  }
