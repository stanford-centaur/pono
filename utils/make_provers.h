...
std::shared_ptr<SafetyProver> make_ceg_proph_safety_prover(
    Engine e,
    const SafetyProperty & p,
    const TransitionSystem & ts,
    const smt::SmtSolver & slv,
...
std::shared_ptr<SafetyProver> make_cegar_values_safety_prover(
    Engine e,
    const SafetyProperty & p,
    const TransitionSystem & ts,
    const smt::SmtSolver & slv,
...
std::shared_ptr<SafetyProver> make_cegar_bv_arith_safety_prover(
    Engine e,
    const SafetyProperty & p,
    const TransitionSystem & ts,
    const smt::SmtSolver & slv,
