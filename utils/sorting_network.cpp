...
TermVec BoolSortingNetwork::sorting_network_helper(TermVec boolvec) const
{
  ...
  else
  {
    ...
    // TODO: Check this
    TermVec left_boolvec = sorting_network_helper(TermVec(boolvec.begin(), boolvec.begin()+pivot));
    TermVec right_boolvec = sorting_network_helper(TermVec(boolvec.begin()+pivot, boolvec.end()));
