...
// else in this suite. Both `rst` and `a` are plain (unregistered)
// inputs, already free from cycle 1 onward, so BMC can pick rst == 0
// and a == 7 simultaneously at cycle 1 itself.
