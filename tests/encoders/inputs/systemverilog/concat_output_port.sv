...
// connection shape. The concatenation splits the child's driven value
// across both halves (hi gets bit 3, lo gets bits 2:0), so hi/lo
// should end up fixed at 4'b1010's halves, not free.
