...
class TransitionSystem
{
 ...
 protected:
  ...
  /** Returns true iff all symbols in term are present in at least one of the term sets
   *  @param term the term to check
   *  @param term_sets a vector of sets to check membership for each symbol in term
