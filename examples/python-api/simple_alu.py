...
def build_simple_alu_fts(s:ss.SmtSolver)->cosa2.Property:
    '''
    ...
    fts = cosa2.FunctionalTransitionSystem(s)
    ...
    prop = cosa2.Property(fts, s.make_term(Equal,
                                           spec_res,
                                           imp_res))
    return prop
...
def interpolant_attempt():
    ...
    itpmc = cosa2.InterpolantMC(prop, s, itp)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Cosa2 SimpleALU example')
    ...
    cosa2.set_global_logger_verbosity(args.verbosity)
